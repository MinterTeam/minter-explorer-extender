...
var transformConfig = map[uint8]TransformTxConfig{
	...
	uint8(transaction.TypeRedeemCheck):             {Model: new(api_pb.RedeemCheckData), Resource: RedeemCheck{}},
	...
	//uint8(transaction.TypeMoveStake):               {Model: new(api_pb.MoveStakeData), Resource: data_resources.MoveStakeData{}},
}
